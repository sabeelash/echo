...
1. The app should be incredibly simple. No fluff. Just do one thing really well. For Echo, that is "Hold Fn -> Speak into it -> Text appears as fast as possible."
2. Nothing extra. Avoid feature creep at all costs. It doesn't need contextual understanding, it doesn't need 20 different styles; it doesn't need post-LLM clean-up, it doesn't need 20 different settings. Be opinionated.
